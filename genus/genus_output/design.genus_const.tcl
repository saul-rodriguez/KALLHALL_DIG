...
set_db -quiet port:counter/enable .driver_pin_rise_min lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/enable .driver_pin_fall_min lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/enable .driver_pin_rise_max lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/enable .driver_pin_fall_max lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/enable .original_name enable
set_db -quiet port:counter/clk .driver_pin_rise_min lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/clk .driver_pin_fall_min lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/clk .driver_pin_rise_max lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/clk .driver_pin_fall_max lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/clk .original_name clk
set_db -quiet port:counter/reset .driver_pin_rise_min lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/reset .driver_pin_fall_min lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/reset .driver_pin_rise_max lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y
set_db -quiet port:counter/reset .driver_pin_fall_max lib_pin:default_emulate_libset_max/kallhall/BUFX2/Y

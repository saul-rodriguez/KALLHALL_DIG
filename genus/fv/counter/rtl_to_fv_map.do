...
# Generated by Genus(TM) Synthesis Solution 18.15-s055_1, revision 1.334b
# Generated on: Tue Sep 21 20:16:36 CEST 2021 (Tue Sep 21 18:16:36 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/counter/rtl_to_fv_map.log -replace
...
set env(RC_VERSION)     "18.15-s055_1"
set env(CDN_SYNTH_ROOT) "/pkg/cadence/installs/GENUS181/tools.lnx86"
set CDN_SYNTH_ROOT      "/pkg/cadence/installs/GENUS181/tools.lnx86"
set env(CW_DIR) "/pkg/cadence/installs/GENUS181/tools.lnx86/lib/chipware"
set CW_DIR      "/pkg/cadence/installs/GENUS181/tools.lnx86/lib/chipware"
...
read_library -liberty -both /home/saul/projects/KALLHALL_DIG/genus/../liberty/merged_ecsm.lib
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../src/counter.v
